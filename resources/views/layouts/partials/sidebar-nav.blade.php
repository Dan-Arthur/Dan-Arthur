...
{{-- ADMISSIONS --}}
@canany(['view admissions', 'view students', 'view disciplinary records'])
...
<a href="{{ route('disciplinary.index') }}" class="sidebar-link {{ request()->routeIs('disciplinary.*') ? 'active' : '' }}">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
    </svg>
    <span x-show="sidebarOpen" class="truncate">Disciplinary</span>
</a>
@endcan
@endcanany

{{-- ACADEMICS --}}
@canany(['view classes', 'view departments', 'view subjects', 'view timetables', 'view attendance', 'view assessments', 'view results', 'manage grading scales', 'view exams'])
...
{{-- OPERATIONS --}}
@canany(['view library', 'view transport', 'view inventory', 'view feeding'])
...
@can('view feeding')
<a href="{{ route('feeding.index') }}" class="sidebar-link {{ request()->routeIs('feeding.*') ? 'active' : '' }}">
    <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
    </svg>
    <span x-show="sidebarOpen" class="truncate">Feeding</span>
</a>
@endcan
@endcanany
...
{{-- ADMINISTRATION --}}
@canany(['manage settings', 'view users', 'manage roles', 'view audit logs', 'view analytics', 'generate reports'])
<p class="sidebar-section" x-show="sidebarOpen">Administration</p>

@canany(['view analytics', 'generate reports'])
